var bigInt = function (e) {
  ...
  function d(e, n) {
    var r = e.length, i = n.length, s = new Array(r), o = 0, u = t, a, f;
  ...
  function m(e, n) {
    var r = e.length, i = new Array(r), s = t, o, u;
  ...
  function E(e, n) {
    var r = e.length, i = new Array(r), s = t, o = 0, u, a;
  ...
  function x(e, t) {
    ...
    n = Math.ceil(n / 2);
    var r = e.slice(n), i = e.slice(0, n), s = t.slice(n), o = t.slice(0, n), u = x(i, o), a = x(r, s),
        f = x(v(i, r), v(o, s));
  ...
  function N(e) {
    var n = e.length, r = h(n + n), i = t, s, o, u, a, f;
    for (u = 0; u < n; u++) {
      a = e[u];
  ...
  function C(e, n) {
    var r = e.length, i = n.length, s = t, o = h(n.length), u = n[i - 1], a = Math.ceil(s / (2 * u)), f = E(e, a),
        c = E(n, a), p, d, v, m, g, y, b;
  ...
  function k(e, n) {
    var r = e.length, i = n.length, s = [], o = [], u = t, a, f, c, h, p;
    while (r) {
      o.unshift(e[--r]);
      if (O(o, n) < 0) {
        s.push(0);
  ...
  function L(e, n) {
    var r = e.length, i = h(r), s = t, o, u, a, f;
    a = 0;
  ...
  function A(e, n) {
    var r, i = $(n), s = e.value, a = i.value, c;
    if (a === 0) throw new Error("Cannot divide by zero");
    if (e.isSmall) return i.isSmall ? [new u(p(s / a)), new u(s % a)] : [J[0], e];
    if (i.isSmall) {
      if (a === 1) return [e, J[0]];
      if (a == -1) return [e.negate(), J[0]];
      var h = Math.abs(a);
      if (h < t) {
        r = L(s, h), c = l(r[0]);
        var d = r[1];
    ...
    var v = O(s, a);
    if (v === -1) return [J[0], e];
    if (v === 0) return [J[e.sign === i.sign ? 1 : -1], J[0]];
    s.length + a.length <= 200 ? r = C(s, a) : r = k(s, a), c = r[0];
    var m = e.sign !== i.sign, g = r[1], y = e.sign;
  ...
  function B(e, t, n) {
    t = $(t);
    var r = e.isNegative(), i = t.isNegative(), s = r ? e.not() : e, o = i ? t.not() : t, u = [], a = [], f = !1,
        l = !1;
  ...
  function j(e, t) {
    return e = $(e), t = $(t), e.greater(t) ? e : t
  }

  function F(e, t) {
    return e = $(e), t = $(t), e.lesser(t) ? e : t
  }

  function I(e, t) {
    return e = $(e).abs(), t = $(t).abs(), e.equals(t) ? e : e.isZero() ? t : t.isZero() ? e : e.isEven() ? t.isOdd() ? I(e.divide(2), t) : I(e.divide(2), t.divide(2)).multiply(2) : t.isEven() ? I(e, t.divide(2)) : e.greater(t) ? I(e.subtract(t).divide(2), t) : I(t.subtract(e).divide(2), e)
  }

  function q(e, t) {
    return e = $(e).abs(), t = $(t).abs(), e.multiply(t).divide(I(e, t))
  }

  function R(e, n) {
    e = $(e), n = $(n);
    var r = F(e, n), i = j(e, n), s = i.subtract(r);
    if (s.isSmall) return r.add(Math.round(Math.random() * s));
    var u = s.value.length - 1, a = [], f = !0;
    for (var c = u; c >= 0; c--) {
      var h = f ? s.value[c] : t, d = p(Math.random() * h);
      a.unshift(d), d < h && (f = !1)
    }
  ...
  function W(e, t) {
    ...
    while (i.isNegative() || i.compareAbs(t) >= 0) {
      ...
      var o = s.remainder;
      o.isNegative() && (o = t.minus(o).abs(), i = i.next()), r.push(z(o))
    }
    return r.push(z(i)), n + r.reverse().join("")
  }
  ...
  function X(e) {
    ...
    var d = [], v = e.length, m = n, g = v - m;
    while (v > 0) d.push(+e.slice(g, v)), g -= m, g < 0 && (g = 0), v -= m;
    return c(d), new o(d, r)
  }

  function V(e) {
    return a(e) ? new u(e) : X(e.toString())
  }

  function $(e) {
    return typeof e == "number" ? V(e) : typeof e == "string" ? X(e) : e
  }

  var t = 1e7, n = 7, r = 9007199254740992, i = f(r), s = Math.log(r);
  o.prototype.add = function (e) {
    var t, n = $(e);
    if (this.sign !== n.sign) return this.subtract(n.negate());
    var r = this.value, i = n.value;
    ...
    var e = this.sign, t = new u(-this.value);
    return t.sign = !e, t
    ...
    var n, r = $(e), i = this.value, s = r.value, u = this.sign !== r.sign, a;
    if (r.isSmall) {
      if (s === 0) return J[0];
      if (s === 1) return this;
    ...
    return e.value === 0 ? J[0] : e.value === 1 ? this : e.value === -1 ? this.negate() : T(Math.abs(e.value), this.value, this.sign !== e.sign)
  }, u.prototype.multiply = function (e) {
    return $(e)._multiplyBySmall(this)
    ...
    var t = $(e), n = this.value, r = t.value, i, s, o;
    if (r === 0) return J[1];
    if (n === 0) return J[0];
    if (n === 1) return J[1];
    if (n === -1) return t.isEven() ? J[1] : J[-1];
    if (t.sign) return J[0];
    ...
    var n = J[1], r = this.mod(t);
    if (r.isZero()) return J[0];
    ...
    var t = $(e), n = this.value, r = t.value;
    return t.isSmall ? 1 : O(n, r)
  }, u.prototype.compareAbs = function (e) {
    var t = $(e), n = Math.abs(this.value), r = t.value;
    ...
    var t = $(e), n = t.value;
    return n === 0 ? !1 : n === 1 ? !0 : n === 2 ? this.isEven() : this.mod(t).equals(J[0])
  }, u.prototype.isDivisibleBy = o.prototype.isDivisibleBy, o.prototype.isPrime = function () {
    var t = M(this);
    if (t !== e) return t;
    var n = this.abs(), r = n.prev(), i = [2, 3, 5, 7, 11, 13, 17, 19], s = r, o, u, a, f;
    while (s.isEven()) s = s.divide(2);
    for (a = 0; a < i.length; a++) {
      f = bigInt(i[a]).modPow(s, n);
      if (f.equals(J[1]) || f.equals(r)) continue;
  ...
  var D = _.length, P = _[D - 1];
  o.prototype.shiftLeft = function (e) {
    if (!H(e)) return e.isNegative() ? this.shiftRight(e.abs()) : this.times(J[2].pow(e));
    e = +e;
    ...
    var t;
    if (!H(e)) return e.isNegative() ? this.shiftLeft(e.abs()) : (t = this.divmod(J[2].pow(e)), t.remainder.isNegative() ? t.quotient.prev() : t.quotient);
    e = +e;
  ...
  var U = function (e, t) {
    var n = J[0], r = J[1], i = e.length;
    if (2 <= t && t <= 36 && i <= s / Math.log(t)) return new u(parseInt(e, t));
    t = $(t);
    var o = [], a, f = e[0] === "-";
    for (a = f ? 1 : 0; a < e.length; a++) {
      var l = e[a].toLowerCase(), c = l.charCodeAt(0);
      if (48 <= c && c <= 57) o.push($(l)); else if (97 <= c && c <= 122) o.push($(l.charCodeAt(0) - 87)); else {
        if (l !== "<") throw new Error(l + " is not a valid character");
        var h = a;
        do a++; while (e[a] !== ">");
        o.push($(e.slice(h + 1, a)))
      }
    }
    o.reverse();
  ...
  o.prototype.toString = function (t) {
    t === e && (t = 10);
    if (t !== 10) return W(this, t);
    var n = this.value, r = n.length, i = String(n[--r]), s = "0000000", o;
    while (--r >= 0) o = String(n[r]), i += s.slice(o.length) + o;
    var u = this.sign ? "-" : "";
    return u + i
  }, u.prototype.toString = function (t) {
    return t === e && (t = 10), t != 10 ? W(this, t) : String(this.value)
  ...
  var J = function (e, t) {
    return typeof e == "undefined" ? J[0] : typeof t != "undefined" ? +t === 10 ? $(e) : U(e, t) : $(e)
  };
  for (var K = 0; K < 1e3; K++) J[K] = new u(K), K > 0 && (J[-K] = new u(-K));
  return J.one = J[1], J.zero = J[0], J.minusOne = J[-1], J.max = j, J.min = F, J.gcd = I, J.lcm = q, J.isInstance = function (e) {
